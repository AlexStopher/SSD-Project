...
namespace EmployeeEnd
{
    ...
    {
        public static CalendarForm m_calendar = new CalendarForm();
        ...
        private void newMember_Button_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Member added succesfully!", "Member adding", MessageBoxButtons.OK);
        }
